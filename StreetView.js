...
/**
 * Custom component for streetview / google maps
 */
class StreetView extends Component {
  ...
  renderMapView(latLang) {
    const map = new this.google.maps.Map(this.node, {
      center: latLang,
...
StreetView.defaultProps = {
  ...
  defaultText: 'Please provide a valid address.',
  errorText: 'Error loading maps for the address',
}
